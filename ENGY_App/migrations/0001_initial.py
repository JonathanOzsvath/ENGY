# Generated by Django 2.2.4 on 2019-09-06 09:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itemNumber', models.CharField(blank=True, max_length=30, null=True)),
                ('description', models.CharField(max_length=500)),
                ('quantity', models.FloatField(blank=True, null=True)),
                ('unit', models.CharField(blank=True, max_length=20, null=True)),
                ('unitPriceOfMaterial', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('pricePerUnit', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
                ('tn_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='ENGY_App.Category', verbose_name='Parent')),
            ],
            options={
